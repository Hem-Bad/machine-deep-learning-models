...
- A collection of not so obvious Python stuff you should know! [[IPython nb](python_reference/tutorials/not_so_obvious_python_stuff.ipynb?create=1)]

- Python's scope resolution for variable names and the LEGB rule [[IPython nb](python_reference/tutorials/scope_resolution_legb_rule.ipynb?create=1)]
...
- Using Cython with and without IPython magic [[IPython nb](python_reference/tutorials/running_cython.ipynb)]

- Parallel processing via the multiprocessing module [[IPython nb](python_reference/tutorials/multiprocessing_intro.ipynb?create=1)]

- Entry point: Data - using sci-packages to prepare data for Machine Learning tasks and other data analyses [[IPython nb](python_reference/tutorials/python_data_entry_point.ipynb?create=1)]

- Awesome things that you can do in IPython Notebooks (in progress) [[IPython nb](python_reference/tutorials/awesome_things_ipynb.ipynb)]

- A collection of useful regular expressions [[IPython nb](python_reference/tutorials/useful_regex.ipynb)]

- Quick guide for dealing with missing numbers in NumPy [[IPython nb](python_reference/tutorials/numpy_nan_quickguide.ipynb)]

- A random collection of useful Python snippets [[IPython nb](python_reference/python_patterns/patterns.ipynb)]

- Things in pandas I wish I'd had known earlier [[IPython nb](python_reference/tutorials/things_in_pandas.ipynb)]
...
- Simple tricks to speed up the sum calculation in pandas [[IPython nb](python_reference/benchmarks/pandas_sum_tricks.ipynb)]
...
- Entry Point: Data - Using Python's sci-packages to prepare data for Machine Learning tasks and other data analyses [[IPython nb](python_reference/tutorials/python_data_entry_point.ipynb)]
